...
class FileDropzone extends Component {
	...
	render() {
		...
		return(
			<Gallery uploader={this.props.uploader} fileInput-accept=".yml,.yaml,.YAML,YML" cancelButton-className={cancelButtonClass} fileInput-disabled={this.props.isUploading} fileInput-children={fileInputChildren} children={children}/>
		);
	}
}
